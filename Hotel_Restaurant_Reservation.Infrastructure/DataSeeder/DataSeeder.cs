...
//            {
//                new Hotel { Id = Guid.NewGuid(), Name = "Grand Hyatt", Url = "http://grandhyatt.com", StarRate = 5, NumberOfRooms = 0, Latitude = 40.7128, Longitude = -74.0060, PropertyTypeId = propertyTypes[0].Id, LocationId = locations[0].Id, MinPrice = 200, MaxPrice = 500},
//                new Hotel { Id = Guid.NewGuid(), Name = "Hollywood Hotel", Url = "http://hollywoodhotel.com", StarRate = 4, NumberOfRooms = 1, Latitude = 34.0928, Longitude = -118.3287, PropertyTypeId = propertyTypes[1].Id, LocationId = locations[1].Id, MinPrice = 150, MaxPrice = 400 },
//                new Hotel { Id = Guid.NewGuid(), Name = "Hollywood Hotel", Url = "http://hollywoodhotel.com", StarRate = 4, NumberOfRooms = 1, Latitude = 34.0928, Longitude = -118.3287, PropertyTypeId = propertyTypes[1].Id, LocationId = locations[1].Id, MinPrice = 150, MaxPrice = 400 },
//                new Hotel { Id = Guid.NewGuid(), Name = "Hollywood Hotel", Url = "http://hollywoodhotel.com", StarRate = 4, NumberOfRooms = 1, Latitude = 34.0928, Longitude = -118.3287, PropertyTypeId = propertyTypes[1].Id, LocationId = locations[1].Id, MinPrice = 150, MaxPrice = 400 },
//                new Hotel { Id = Guid.NewGuid(), Name = "Hollywood Hotel", Url = "http://hollywoodhotel.com", StarRate = 4, NumberOfRooms = 1, Latitude = 34.0928, Longitude = -118.3287, PropertyTypeId = propertyTypes[1].Id, LocationId = locations[1].Id, MinPrice = 150, MaxPrice = 400 },
//                new Hotel { Id = Guid.NewGuid(), Name = "Hollywood Hotel", Url = "http://hollywoodhotel.com", StarRate = 4, NumberOfRooms = 1, Latitude = 34.0928, Longitude = -118.3287, PropertyTypeId = propertyTypes[1].Id, LocationId = locations[1].Id, MinPrice = 150, MaxPrice = 400 },
...
//            {
//                new Restaurant { Id = Guid.NewGuid(), Name = "Italiano's", Description = "Authentic Italian food", Url = "http://italianos.com", PictureUrl = "http://italianos.com/pic.jpg", StarRating = 4.5, Latitude = 40.7128, Longitude = -74.0060, NumberOfTables = 20, PriceLevel = RestaurantPriceLevel.Medium, MinPrice = 15, MaxPrice = 50, LocationId = locations[0].Id},
//                new Restaurant { Id = Guid.NewGuid(), Name = "Taco Town", Description = "The best tacos in town", Url = "http://tacotown.com", PictureUrl = "http://tacotown.com/pic.jpg", StarRating = 4.0, Latitude = 34.0928, Longitude = -118.3287, NumberOfTables = 15, PriceLevel = RestaurantPriceLevel.Low, MinPrice = 5, MaxPrice = 20, LocationId = locations[1].Id },
//                new Restaurant { Id = Guid.NewGuid(), Name = "Taco Town", Description = "The best tacos in town", Url = "http://tacotown.com", PictureUrl = "http://tacotown.com/pic.jpg", StarRating = 4.0, Latitude = 34.0928, Longitude = -118.3287, NumberOfTables = 15, PriceLevel = RestaurantPriceLevel.Low, MinPrice = 5, MaxPrice = 20, LocationId = locations[1].Id },
//                new Restaurant { Id = Guid.NewGuid(), Name = "Taco Town", Description = "The best tacos in town", Url = "http://tacotown.com", PictureUrl = "http://tacotown.com/pic.jpg", StarRating = 4.0, Latitude = 34.0928, Longitude = -118.3287, NumberOfTables = 15, PriceLevel = RestaurantPriceLevel.Low, MinPrice = 5, MaxPrice = 20, LocationId = locations[1].Id },
//                new Restaurant { Id = Guid.NewGuid(), Name = "Taco Town", Description = "The best tacos in town", Url = "http://tacotown.com", PictureUrl = "http://tacotown.com/pic.jpg", StarRating = 4.0, Latitude = 34.0928, Longitude = -118.3287, NumberOfTables = 15, PriceLevel = RestaurantPriceLevel.Low, MinPrice = 5, MaxPrice = 20, LocationId = locations[1].Id },
//                new Restaurant { Id = Guid.NewGuid(), Name = "Taco Town", Description = "The best tacos in town", Url = "http://tacotown.com", PictureUrl = "http://tacotown.com/pic.jpg", StarRating = 4.0, Latitude = 34.0928, Longitude = -118.3287, NumberOfTables = 15, PriceLevel = RestaurantPriceLevel.Low, MinPrice = 5, MaxPrice = 20, LocationId = locations[1].Id },
...
//            {
//                new Event { Id = Guid.NewGuid(), Name = "Music Festival", Description = "A festival of music.", StartingDateTime = DateTime.UtcNow.AddDays(30), EndDateTime = DateTime.UtcNow.AddDays(32), PayToEnter = 50, MaxNumberOfRegesters = 500, LocationId = locations[2].Id},
//                new Event { Id = Guid.NewGuid(), Name = "Food Fair", Description = "A fair for foodies.", StartingDateTime = DateTime.UtcNow.AddDays(60), EndDateTime = DateTime.UtcNow.AddDays(61), PayToEnter = 20, MaxNumberOfRegesters = 300, LocationId = locations[2].Id }
//            };
...
//        // Seed WorkTimes
//        var workTimes = new List<RestaurantWorkTime>
//        {
//            new RestaurantWorkTime { Id = Guid.NewGuid(), Day = "Monday", OpenHour = new TimeOnly(9, 0), CloseHour = new TimeOnly(22, 0) },
//            new RestaurantWorkTime { Id = Guid.NewGuid(), Day = "Tuesday", OpenHour = new TimeOnly(9, 0), CloseHour = new TimeOnly(22, 0) },
//        };
//        await _dbContext.RestaurantWorkTime.AddRangeAsync(workTimes);
//        await _dbContext.SaveChangesAsync();
