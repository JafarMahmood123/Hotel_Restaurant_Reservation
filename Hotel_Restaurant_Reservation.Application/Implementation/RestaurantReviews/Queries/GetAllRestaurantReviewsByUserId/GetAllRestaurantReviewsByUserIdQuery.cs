...
{
    public class GetAllRestaurantReviewsByUserIdQuery : IQuery<Result<IEnumerable<RestaurantReviewResponse>>>
    {
        public GetAllRestaurantReviewsByUserIdQuery(Guid userId)
        {
            UserId = userId;
        }
